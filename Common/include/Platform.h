...
#define PL_HAS_LED_HEARTBEAT  (0 && PL_NOF_LEDS>0)
...
#define PL_HAS_NRF24_RADIO    (0) /* nRF24L01+ radio */
  /*!< Set to one if we have Radio */
#define PL_HAS_LINE_ACTION (0)

#define PL_HAS_CONFIG_NVM  0
#define PL_APP_ACCEL_CONTROL_SENDER (1 && PL_IS_SRB)
#define PL_HAS_REMOTE 0
#define PL_IS_ROBOT   0
#define PL_IS_INTRO   1
#define PL_HAS_MOTOR_PID 0
#define PL_IS_WILCO_SPS  0
#define PL_IS_WILCO_SENSOR 0
